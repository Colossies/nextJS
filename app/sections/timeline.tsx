...
export default async function Timeline() {
  ...
  return (
    <div className = "lg:px-[20%] w-full min-h-svh p-4 mt-2">
      <h2 className = "w-full text-center text-5xl mb-10 font-bold">My Journey</h2>
        ...
        {timeline.map((o, index) => (
          <li className = "timeline ms-4 pb-8 relative before:absolute after:absolute" key = {o.id}>
            ...
            <div className = "mb-2">
              ...
              <span className = "mb-1 text-sm font-normal leading-none text-gray-500">{o.date}</span>
            </div>
